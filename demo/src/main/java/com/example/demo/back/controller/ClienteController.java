...
import com.example.demo.back.model.DTOs.*;
import com.example.demo.back.service.CustomClienteDetails;
...
import com.example.demo.back.service.ClienteService;
...
public class ClienteController {
    ...
    public ResponseEntity<LoginResponseDTO> login(@RequestBody @Valid AuthenticationDTO data) {
        ...
        var customClienteDetails = (CustomClienteDetails) auth.getPrincipal(); // Cast para CustomFornecedorDetails
        var cliente = customClienteDetails.getCliente(); // Obtém o fornecedor a partir do CustomFornecedorDetails
